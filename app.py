...
async def run_agent(request: QueryRequest):
    ...
    prompt = """
                ...
                For each user query:
                - Use at most 3 Tavily tool calls in total (search, extract, or crawl).
                - Prefer: 1–2 TavilySearch calls to find sources, then 1 TavilyExtract to pull details.
                - Once you have 3–5 good sources, STOP calling tools and synthesize an answer.
                - Do not continue searching just to find more sources.
                - If you cannot find information after 3 tool calls, say so explicitly.
                """
    try:
